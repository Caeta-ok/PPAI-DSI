...
namespace 
{
    public partial class Frm_Escritorio : Form
    {
        ...
        private void Frm_Escritorio_Load(object sender, EventArgs e)
        {
            ...
            Ng_User usu = new Ng_User();
            id_usr = usu.Recuperar_id(init.user, init.passwor);
            nom_usr = init.user;
            pssw = init.passwor;
            init.Dispose();
        }
        ...
        private void Reset()
        {
            ...
            icn_actual.IconColor = RGBColors.color3;
